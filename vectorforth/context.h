...
struct context
  ...
  char* constant_space_pointer; // offset 112
...
VECTOR_FORTH_API context create_context(uint64_t stack_size_in_bytes, uint64_t constant_space_in_bytes, uint64_t data_space_size_in_bytes);
